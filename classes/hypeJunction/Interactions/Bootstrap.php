...
class Bootstrap extends PluginBootstrap {
	...
	public function init() {
		...
		\elgg_register_event_handler('entity:url', 'object', [Router::class, 'urlHandler']);
		\elgg_register_event_handler('entity:icon:url', 'object', [Router::class, 'iconUrlHandler']);

		// Replace comments block
		\elgg_register_event_handler('comments', 'all', ReplaceCommentsBlock::class);
		...
		\elgg_register_event_handler('update:after', 'all', SyncRiverObjectAccess::class);

		// Setup subscriptions
		\elgg_register_event_handler('create', 'object', SubscribeToCommentNotifications::class);

		// Configure permissions
		\elgg_register_event_handler('container_logic_check', 'object', CanCommentOnComment::class);
		\elgg_register_event_handler('permissions_check', 'annotation', CanEditLikeAnnotation::class);

		// Setup menus
		\elgg_register_event_handler('register', 'menu:interactions', InteractionsMenu::class);
		\elgg_register_event_handler('register', 'menu:river', RiverMenu::class);
		...
		\elgg_register_event_handler('likes:is_likable', 'object:river_object', [\Elgg\Values::class, 'getTrue']);
	...
	public function ready() {
		// Clean up
		\elgg_unregister_event_handler('register', 'menu:social', '_elgg_comments_social_menu_setup');
		\elgg_unregister_event_handler('register', 'menu:social', 'likes_social_menu_setup');
